...
\begin{equation}
  S^{\mathrm{liq}}_i(t) = \frac{D_i(t)}{C_i\,\theta_i}.
  \label{eq:liqbarrier}
\end{equation}
For multi-asset, yield-bearing, or option collateral, no single spot barrier is sufficient; the engine solves $\HF_i(t) = 1$ using full portfolio revaluation.
