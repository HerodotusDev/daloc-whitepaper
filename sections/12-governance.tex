...
Settlement correctness is guaranteed by zero-knowledge proofs (Section~\ref{sec:settlement}), but liveness is not: if a market's off-chain infrastructure halts, no new epochs advance for that market. Existing positions remain safe---collateral stays locked, debt is unchanged, intent cancellation remains available---but undercollateralized positions go undetected until epochs resume.
